...
EmailNotification({
    ...
    emailContent: {
        ...
        messageText: text([
            ...
            'Start:    ${training_session.start_datetime}',
            'Room:     ${training_session.room}',
            '',
...
EmailNotification({
    ...
    emailContent: {
        contentType: 'text/plain',
        subject: 'You are on the waitlist for ${training_session}',
        messageText: text([
            'Hi ${student.user.first_name},',
            '',
...
EmailNotification({
    ...
    emailContent: {
        contentType: 'text/plain',
        subject: 'Reminder: ${training_session} is coming up soon',
        messageText: text([
            'Hi ${student.user.first_name},',
            '',
            ...
            'Start:    ${training_session.start_datetime}',
            'Room:     ${training_session.room}',
            'Location: ${training_session.room.location}',
            '',
...
EmailNotification({
    ...
    emailContent: {
        contentType: 'text/plain',
        subject: 'Action required: confirm your attendance for ${training_session}',
        messageText: text([
            'Hi ${student.user.first_name},',
            '',
            ...
            'Session:  ${training_session}',
            'Start:    ${training_session.start_datetime}',
            'Deadline: ${training_session.confirmation_deadline}',
            '',
...
EmailNotification({
    ...
    emailContent: {
        contentType: 'text/plain',
        subject: 'Training session ${training_session} has been cancelled',
        messageText: text([
            'Hi ${student.user.first_name},',
            '',
...
EmailNotification({
    ...
    emailContent: {
        contentType: 'text/plain',
        subject: 'How was your training? Share your feedback for ${training_session}',
        messageText: text([
            'Hi ${student.user.first_name},',
            '',
            ...
            '',
            'Session:  ${training_session}',
            'Date:     ${training_session.start_datetime}',
            '',

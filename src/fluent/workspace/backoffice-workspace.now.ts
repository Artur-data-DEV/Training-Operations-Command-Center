            ...
            lists: [
                {
                    ...
                    columns: 'number,status,short_description,tocc_course,tocc_instructor,tocc_room,start_datetime,end_datetime,expected_participants,sys_updated_on',
                ...
                },
                {
                    ...
                    order: 200,
                    table: 'x_783010_tocc_a1_room_reservation',
                    columns: 'number,status,short_description,tocc_course,tocc_instructor,tocc_room,start_datetime,expected_participants,sys_updated_on',
            ...
            lists: [
                {
                    ...
                    columns: 'number,status,title,tocc_course,room,tocc_instructor,start_datetime,end_datetime,total_seats,available_seats',
                    condition: 'statusINopen,full^tocc_courseISNOTEMPTY^roomISNOTEMPTY^tocc_instructorISNOTEMPTY',
                },
                {
            ...
            lists: [
                {
                    ...
                    columns: 'resource_name,resource_type,room,quantity,ci_reference,active',
...
export const toccBackofficeWorkspace = Workspace({

            ...
            lists: [
                {
                    ...
                    columns: 'number,status,short_description,course,instructor,room,start_datetime,end_datetime,expected_participants,sys_updated_on',
                ...
                },
                {
                    ...
                    order: 200,
                    table: 'x_783010_tocc_a1_room_reservation',
                    columns: 'number,status,short_description,course,instructor,room,start_datetime,expected_participants,sys_updated_on',
            ...
            lists: [
                {
                    ...
                    columns: 'number,status,title,course,room,instructor,start_datetime,end_datetime,total_seats,available_seats',
                    condition: 'statusINopen,full^courseISNOTEMPTY^roomISNOTEMPTY^instructorISNOTEMPTY',
                },
                {

...
> **Version:** 1.2 - Sprint 12
> **Scope:** `x_783010_tocc_a1`
> **Status:** SDK-first. Core flow/subflow scaffolds are generated by Fluent SDK and activated from Flow Designer.
...
| `x_783010_tocc_a1.flow.reservation_intake_signal` | `x_783010_tocc_a1_room_reservation` | Fluent Flow scaffold `[TOCC][FLOW] Reservation Intake Signal` |
| `x_783010_tocc_a1.flow.session_cancelled_signal` | `x_783010_tocc_a1_training_session` | Fluent Flow scaffold `[TOCC][FLOW] Session Cancelled Signal` |
...
### Step 4 - Review SDK-generated Flows/Subflows

Navigate to: **Flow Designer -> Flows**

Confirm the following records exist (generated from `src/fluent/flows/training-orchestration-flows.now.ts`):
...
Activate only after event registry verification and run:
...
*Last updated: Sprint 12 - Flow/subflow scaffolds are code-generated by SDK with activation runbook coverage.*
